        ...
        <div className="prose prose-gray max-w-none space-y-8 text-sm leading-relaxed text-gray-600">
          ...
          <section>
            ...
            <p>
              ...
              financeira por cada indicação que se tornar cliente contratante da Auto Excelência.
            </p>
          ...
          <section>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              <li>O indicador compartilha seu link exclusivo com potenciais clientes.</li>
              <li>O cliente indicado acessa o link e preenche o formulário de interesse.</li>
            ...
            <p className="mt-3">
              Uma indicação é considerada válida apenas quando o cliente indicado efetivamente
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>Fornecer dados falsos de clientes indicados ou indicar a si mesmo.</li>
              ...
              <li>Prometer benefícios ou incentivos não autorizados pela Auto Excelência aos clientes indicados.</li>
          ...
          <section>
            ...
            <p>
              Ao cadastrar um cliente indicado, você declara ter o consentimento desta pessoa para
